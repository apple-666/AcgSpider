...
headers = {
    ...
    'referer': 'https://bbs.linkshar.com/2048/login.php?',
    'cookie': 'zh_choose=n; a22e7_threadlog=,280,67,180,; a22e7_winduser=VVYGVwkGVjlVDFFWBQwGVl0NVVQCVwACVVEBAwVRUFpUVFQIVVdTBzEHVVMCUgpXDFsB; a22e7_ck_info=/	; a22e7_lastvisit=0	1670736842	/2048/thread.php?fid-180-page-5.html; a22e7_lastpos=F180; a22e7_ol_offset=146762'
}
...
if __name__ == "__main__":
    ...
    #     }, {
    #         "https": "https://{0}".format(proxy[1]),
    #         "http": "http://{0}".format(proxy[1])
    #     }
    # ]
    # http = random.choice(proxies)
    # print(http)
    # response = requests.get(src, proxies=http, headers=headers)
